                                     ...
                                     ILogger& log)
{
    ...
    auto cost_vol = addCostVolume(plugin_factory, *network, *left_encoder2D_out->getOutput(0), *right_encoder2D_out->getOutput(0), 68, "cost_vol");
    ...
    // Softargmax.
    auto disp = addSoftargmax(plugin_factory, *network, *deconv3D_5_slice_layer->getOutput(0), "disp_softargmax");
    assert(disp != nullptr);
